      ...
      BarComponent{
          ...
          RowLayout {
              ...
              ColumnLayout {
                  ...
                  Text {
                      ...
                      Timer {
                          ...
                          running: true
                          repeat: true
                          onTriggered: timeText2.text = Qt.formatDateTime(new Date(), "hh:mm A")
                      }
                  }
              }
            }
              ...
              RowLayout {
                  ...
                  Text {
                      text: battery.charge + "%"
                      color: battery.charging ? "green" : (battery.charge < 20 ? "red" : "white")
                      font.pixelSize: 12

                      property var battery: System.Battery  // Changed from Battery
                  }
                  ...
                  Text {
                      ...
                      property var audio: System.Audio.defaultSink  // Changed from Audio
                  }
              }
          }
      }
